## GETTR
We have statically analyzed the Android application GETTR `com.gettr.gettr` available on [Google Play](https://play.google.com/store/apps/details?id=com.gettr.gettr) in its version `1.0.5`.
