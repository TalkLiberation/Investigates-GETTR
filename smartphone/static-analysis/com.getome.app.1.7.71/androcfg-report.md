## Getome
We have statically analyzed the Android application Getome `com.getome.app` available on [Google Play](https://play.google.com/store/apps/details?id=com.getome.app) in its version `1.7.71`.
...
* The application probably gets different information regarding the telephony capabilities *via* the following technical means [^readTelephonyInfo]:
    ...
    * `g/c/a/t` provided by the company XXXX [^85f06bbe9f3f026bc30cb42b8be64409]
    * `com/google/android/datatransport/cct/d` provided by the company XXXX [^dfb4d6a18f023aaaf1793a89266803cc]
...
* The application probably sends data over HTTP/S *via* the following technical means [^sendDataHttp]:
    ...
    * `g/k/a/b/d/b/b$b` provided by the company XXXX [^5cac75daaeeb1d04d4ad9f302964db54]
...
* The application probably gets memory and CPU information *via* the following technical means [^readRuntimeInfo]:
    ...
    * `g/k/a/b/e/a` provided by the company XXXX [^901f4104a85427aec27e59777dbd9c66]
